...
enum class ExprKind {
    Number, String, Bool, Empty, Identifier, List, Map, FString,
    BinaryOp, UnaryOp, IndexAccess, SliceAccess, FunctionCall, Await, RegexMatch
};
...
struct FunctionDecl {
    enum class FuncKind { Normal, Returnable, Async };
    FuncKind funcKind;
    std::string name;
...
struct LoopStmt {
    enum class LoopKind { Repeat, While, Match };
    LoopKind kind;
...
struct CollectionOpStmt {
    enum class OpKind { Add, Remove, Replace };
    OpKind opKind;
...
enum class StmtKind {
    Declaration, Change, FunctionDecl, IfStmt, LoopStmt,
    StopStmt, ReturnStmt, AwaitStmt, UseStmt, ExprStmt,
    CollectionOp, OrElse
};
